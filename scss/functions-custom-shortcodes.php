...
// Custom Shortcodes
//  *********************************************************************************
// Meta Box on Pages for Shortcodes
function adding_custom_meta_boxes( $post ) {
    add_meta_box( 
        'she-sc-reference',
        __( 'Shortcode Reference' ),
        'render_she_sc_reference',
        'page',
        'normal',
        'default'
    );
...
function render_she_sc_reference(){
    ob_start();
    ?>
        <dl>
            <dt><strong>[Vimeo id=""]</strong></dt>
            <dl>Creates a full screen Vimeo with popup embed. 'id' is the reference number in the URL: vimeo.com/123345</dl>
            <dt><strong>[Button] ... [/Button]</strong></dt>
            <dl>Converts the text between the tags into a larger "ghost" style button.</dl>
            <dt><strong>[DisplayPage id=""]</strong></dt>
            <dl>Displays the contents of any page from the site. 'id' is the reference number in the URL.</dl>
            <dt><strong>[DisplayBlogsLoop]</strong></dt>
            <dl>Displays the latest blog posts.</dl>
        </dl>
        <hr>
        <h4>Block Grids</h4>
        <p>Block Grids are equally spaced columns of information. The number represents the amount of columns on a large screen. For smaller screen sizes, the columns will collapse into one.</p>
        <p>You will wrap the section as a whole, and wrap each individual item.
        <p><strong>Example: Making a 2x2 square.</strong></p>
        <blockquote><p>[BlockGridTwo]</p>
        <p>[BlockGridItem]...[/BlockGridItem]</p>
        <p>[BlockGridItem]...[/BlockGridItem]</p>
        <p>[BlockGridItem]...[/BlockGridItem]</p>
        <p>[BlockGridItem]...[/BlockGridItem]</p>
        <p>[/BlockGridTwo]</p></blockquote>
        <dl>
            <dt><strong>[BlockGridTwo]...[/BlockGridTwo]</strong></dt>
            <dl>Will organize Items into two columns.</dl>
            <dt><strong>[BlockGridThree]...[/BlockGridThree]</strong></dt>
            <dl>Will organize Items into three columns.</dl>
            <dt><strong>[BlockGridSix]...[/BlockGridSix]</strong></dt>
            <dl>Will organize Items into six columns.</dl>
            <dt><strong>[BlockGridItem]...[/BlockGridItem]</strong></dt>
            <dl>Shortcode for all items.</dl>
        </dl>
    <?php
    return ob_flush();
}
...
function she_sc_grid_two( $atts, $content = null ) {
    return '</div><div class="frame equalizer-content">' . do_shortcode( $content ) . '</div><div class="box-padding page-defaults">';
}
...
function she_sc_griditemtwo( $atts, $content = null ) {
    return '<div class="bit-2"><div class="box-padding text-center">' . do_shortcode( $content ) . '</div></div>';
}
add_shortcode( 'GridItemTwo', 'she_sc_griditemtwo' );
function she_sc_griditemthree( $atts, $content = null ) {
    return '<div class="bit-3"><div class="box-padding text-center">' . do_shortcode( $content ) . '</div></div>';
}
add_shortcode( 'GridItemThree', 'she_sc_griditemthree' );
function she_sc_griditemsix( $atts, $content = null ) {
    return '<div class="bit-6"><div class="box-padding text-center">' . do_shortcode( $content ) . '</div></div>';
}
    ...
    <div class="frame">
        <div class="bit-1">
            <div class="box-padding">
                <div class="she-border-bottom-blue">
                    <h3 class="she-blue-text text-center"><strong>Healthy Homes and Communities</strong></h3>
                </div>
                <div class="she-blue-triangle-mini"></div>
            </div>
        </div>
               ...
               <div class="vimeo-tagline-header she-trans-blue">
                  <span class="she-vimeo-overlay-link">
                   ...
                   <h4><?php echo $tagline; ?></h4>
                    <BR><BR>
                    <h3 class="uppercase she-blue-text"><strong>PLAY VIDEO &#x25b6;</strong></h3>                                
                    <BR><BR>
                    </span> 
              </div>
    ...
    ob_start();
     ...
     <div class="frame she-intake-overlay-off">
            ...
            <div class="bit-1">
              ...
              <h2 style="color:#fff;">Interest Form</h2>
              <h4 style="color:#fff;">Please fill out the form.</h4>
            <?php echo do_shortcode( '[contact-form-7 id="688" title="Contact form 1" html_class="form contact-form"]' ); ?>
            </div>
        </div> 
        <span class="she-intake-overlay-link she-blue-ghost-btn">Intake Form</span>
...
function she_sc_job_postings( $atts, $content = null  ){
    ...
    <?php foreach ($articles_array as $post ) { 
            ?>
            <div class="bit-3">
                <div class="box-padding">
...
add_shortcode( 'ShowAttachedGalleries', 'she_custom_gallery_shortcode' ); 
