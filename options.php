...
function optionsframework_options() {
	...
	// Begin Orbit Front Page Image Tab 
	$options[] = array(
		'name' => __('Front Page Image', 'options_framework_theme'),
		'type' => 'heading');
	$options[] = array(
		'name' => __('Featured Image One', 'options_framework_theme'),
		'desc' => __('Enable Featured Image One.', 'options_framework_theme'),
		'id' => 'orbit_visible_one',
		'type' => 'checkbox');

	$options[] = array(
		'name' => __('Featured Image', 'options_framework_theme'),
		'desc' => __('Please select a featured image for the front page.', 'options_framework_theme'),
		'id' => 'orbit_front_image_one',
		'class' => 'hidden',
		'type' => 'upload');

	$options[] = array(
		'name' => __('TaglineText', 'options_framework_theme'),
		'desc' => __('Input the tagline that will overlay the image.', 'options_framework_theme'),
		'id' => 'orbit_tagline_text_one',
		'std' => 'Welcome to Self-Help Enterprises',
		'class' => 'hidden',
		'type' => 'text');

	$options[] = array(
		'name' => __('Button Text', 'options_framework_theme'),
		'desc' => __('The text inside of the call-to-action button.', 'options_framework_theme'),
		'id' => 'orbit_button_text_one',
		'std' => 'Click Here',
		'class' => 'mini hidden',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Select a page for button to link to.', 'options_framework_theme'),
		'id' => 'orbit_select_pages_one',
		'type' => 'select',
		'class' => 'hidden',
		'options' => $options_pages);

	// Begin Front Page Text Options Tab
	$options[] = array(
	...
	$options[] = array(
		'name' => __('Front Page Content', 'options_framework_theme'),
		'desc' => __('This will appear directly below the hero image.', 'options_framework_theme'),
		'id' => 'front-content',
		'type' => 'editor');	



	// Begin Featured Vimeo Options Tab
	$options[] = array(
		'name' => __('Featured Vimeo', 'options_framework_theme'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Input Vimeo Code', 'options_framework_theme'),
		'desc' => __('Input the 8 digit vimeo code. Example: for vimeo.com/95451221 the code would be 95451221', 'options_framework_theme'),
		'id' => 'vimeo_code',
		'std' => '12345678',
		'class' => 'mini',
		'type' => 'text');	
	$options[] = array(
		'name' => __('Heading Text', 'options_framework_theme'),
		'desc' => __('Input the tagline that will overlay the image.', 'options_framework_theme'),
		'id' => 'vimeo_tagline_text',
		'std' => 'Welcome to Self-Help Enterprises',
		'type' => 'text');
	$options[] = array(
		'name' => __('Sub Heading Text', 'options_framework_theme'),
		'desc' => __('Input the tagline that will overlay the image.', 'options_framework_theme'),
		'id' => 'vimeo_sub_tagline_text',
		'std' => 'Welcome to Self-Help Enterprises',
		'type' => 'text');
	$options[] = array(
		'name' => __('Vimeo Featured Image', 'options_framework_theme'),
		'desc' => __('Please select a featured image for the front page.', 'options_framework_theme'),
		'id' => 'vimeo_featured_image',
		'class' => 'mini',
		'type' => 'upload');
	...
	// Begin Custom Menu Options Tab
	$options[] = array(
		'name' => __('Custom Menu', 'options_framework_theme'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Select About Page', 'options_framework_theme'),
		'desc' => __('Select the About Page.', 'options_framework_theme'),
		'id' => 'menu_about',
		'type' => 'select',
	...
	$options[] = array(
		'name' => __('Select Programs Page', 'options_framework_theme'),
		'desc' => __('Select the Programs Page.', 'options_framework_theme'),
		'id' => 'menu_program',
		'type' => 'select',
	...
	$options[] = array(
		'name' => __('Select News and Multimedia Page', 'options_framework_theme'),
		'desc' => __('Select the News and Multimedia Page.', 'options_framework_theme'),
		'id' => 'menu_news',
		'type' => 'select',
	...
	$options[] = array(
		'name' => __('Select Get Involved Page', 'options_framework_theme'),
		'desc' => __('Select the Get Involved Page.', 'options_framework_theme'),
		'id' => 'menu_getinvolved',
		'type' => 'select',
	...
	$options[] = array(
		'name' => __('Select Contact Us Page', 'options_framework_theme'),
		'desc' => __('Select the Contact Us Page.', 'options_framework_theme'),
		'id' => 'menu_contact',
		'type' => 'select',
	...
	// Begin Get Involved Options Tab
	$options[] = array(
		'name' => __('Get Involved Footer', 'options_framework_theme'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Get Involved Background Image', 'options_framework_theme'),
		'desc' => __('Please select a background image for the Get Involved area of the front page.', 'options_framework_theme'),
		'id' => 'involved_featured_image',
		'class' => 'mini',
		'type' => 'upload',
