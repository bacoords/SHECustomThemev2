...
<?php    $current_pdf = get_post_meta(get_the_ID(), '_she_newsletter_news_pdf',TRUE); 
 ?>
					                ...
					                <div class="frame">
					                	<div class="bit-1">
					                		<div class="art-toggle-body" style="display:none">
												...
												<?php if ($current_pdf ): ?>
													<BR><BR><BR><BR>
													<a href="<?php echo $current_pdf; ?>" class="she-blue-ghost-btn text-right" target="new">View Newsletter</a>
												<?php endif ?>
    ...
    <div class="frame">
        <div class="bit-1">
            <div class="text-center">
                <a href="http://visitor.r20.constantcontact.com/d.jsp?llr=xgxexupab&p=oi&m=1116313115863&sit=tut4q8oib&f=c3b373c6-daf4-4a53-9ac0-2cff4d91ceb1" class="she-blue-ghost-btn" target="_blank">Subscribe to our Newsletter</a>
            </div>
        </div>
    </div>
