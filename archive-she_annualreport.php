...
<?php    $current_pdf = get_post_meta(get_the_ID(), '_she_annualreport_news_pdf',TRUE); 
        ?>
					                ...
					                <div class="frame">
					                	<div class="bit-1">
					                		<div class="art-toggle-body" style="display:none">
												...
												<?php if ($current_pdf ): ?>
													<BR><BR><BR><BR>
													<a href="<?php echo $current_pdf; ?>" class="she-blue-ghost-btn text-right" target="new">DOWNLOAD</a>
												<?php endif ?>
